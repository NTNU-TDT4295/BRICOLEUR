...
## Pynq => MCU GPIO
set_property -dict { PACKAGE_PIN V10   IOSTANDARD LVCMOS33 } [get_ports { mcu_gpio[0] }]; #IO33 LSB
set_property -dict { PACKAGE_PIN U17   IOSTANDARD LVCMOS33 } [get_ports { mcu_gpio[1] }]; #IO7 Middle SB
set_property -dict { PACKAGE_PIN V15   IOSTANDARD LVCMOS33 } [get_ports { mcu_gpio[2] }]; #IO4 MSB
