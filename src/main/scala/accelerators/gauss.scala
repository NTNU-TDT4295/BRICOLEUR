...
// after copying the file, run sbt, then compile, then run the accelerators.Tester
object Tester extends App{
  //chisel3.Driver.execute(args, () => new accelerators.GaussianBlur(320, 240))
  // The arguments for accelerators.GaussianBlur determines the dimensions of the data to be put in, aka the image size
