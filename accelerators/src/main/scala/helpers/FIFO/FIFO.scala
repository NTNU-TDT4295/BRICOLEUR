...
/**
  * FIFOAlt queue with UInt instead of FixedPoint
  *
  * @param depth       : size of queue
  * @param dataWidth   : data width of signal
  * @param binaryPoint : binary point of data width
  */
class FIFOAltUInt(depth: Int, dataWidth: Int, binaryPoint: Int) extends Module { // Defining the behaviour of the accelerators.FIFO queue
  val io = IO(new Bundle {
